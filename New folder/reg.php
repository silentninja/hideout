...
#register:before { /* couture autour du formulaire */
...
<body>
 <?php
       ...
       $conn=connect();
 $html=<<<HERE
	<form id="register" method="post" action="regsubmit.php">

    <h1 id="ff-proof" class="ribbon">NINJA CART &nbsp;&nbsp;</h1>

    <div class="NINJA CART"></div>

    <fieldset id="inputs">

      <input name="user" type="text" onblur="if(this.value=='')this.value='username';" onfocus="if(this.value=='username')this.value='';" value="username" />


<input name="emailid" type="text" onblur="if(this.value=='')this.value='Email id';" onfocus="if(this.value=='username')this.value='';" value="Email id" />
<input name="pass" type="password" onblur="if(this.value=='')this.value='password';" onfocus="if(this.value=='username')this.value='';" value="password" />
<input name="vpass" type="password" onblur="if(this.value=='')this.value='vpassword';" onfocus="if(this.value=='username')this.value='';" value="vpassword" />
    </fieldset>
    ...
    <fieldset id="actions">
       ...
       <a href="index.php"><p class="option">Login</p></a>
