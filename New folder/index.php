...
<body>
 ...
 $html=<<<HERE
    ...
    <fieldset id="inputs">
      ...
      <input id="username" type="text" onblur="if(this.value=='')this.value='username';" onfocus="if(this.value=='username')this.value='';" value="username" name="user" />

      <input id="password" type="password" onblur="if(this.value=='')this.value='Password';" onfocus="if(this.value=='Password')this.value='';" value="Password" name="pass" />
    ...
    <fieldset id="actions">
       ...
       <a href="reg.php"><p class="option">Register</p></a>
